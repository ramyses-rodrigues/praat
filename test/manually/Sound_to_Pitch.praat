...
stopwatch
pitch1 = noprogress To Pitch (raw autocorrelation): 0.001, 75, 600, 15, "no", 0.03, 0.45, 0.01, 0.35, 0.14
appendInfoLine: stopwatch
sound01 = Create Sound from formula: "sineWithNoise", 1, 0, 0.1, 44100, "1/2 * sin(2*pi*377*x) + randomGauss(0,1)"
stopwatch
pitch01 = noprogress To Pitch (raw autocorrelation): 0.001, 75, 600, 15, "no", 0.03, 0.45, 0.01, 0.35, 0.14
appendInfoLine: stopwatch
