...
Prefs_begin (TextGridArea)
	...
	InstancePrefs_addDouble       (TextGridArea, vad_speechThreshold,      1, theVadDefaultThreshold)
	InstancePrefs_addDouble       (TextGridArea, vad_minNonSpeech,         1, theVadDefaultMinNonSpeechDuration)
	InstancePrefs_addDouble       (TextGridArea, vad_minSpeech,            1, theVadDefaultMinSpeechDuration)
	InstancePrefs_addDouble       (TextGridArea, vad_speechPadding,        1, theVadDefaultSpeechPad)
