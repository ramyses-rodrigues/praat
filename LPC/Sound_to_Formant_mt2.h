...
Thing_define (SoundFrameIntoFormantFrame2, SampledFrameIntoSampledFrame2) {

	autoSoundFrameIntoLPCFrame2 soundIntoLPC;
	autoLPCFrameIntoFormantFrame2 lpcIntoFormant;

	void initBasic (constSound inputSound, mutableFormant outputFormant);
...
autoSoundFrameIntoFormantFrame2 SoundFrameIntoFormantFrame2_create (SoundFrameIntoLPCFrame2 soundIntoLPC, 
	LPCFrameIntoFormantFrame2 lpcIntoFormant);
