...
Prefs_begin (TextGridArea)
	...
	InstancePrefs_addDouble       (TextGridArea, transcribe_vadThreshold,  1, theVadDefaultThreshold)
	InstancePrefs_addDouble       (TextGridArea, transcribe_vadMinNonSpeech, 1, theVadDefaultMinNonSpeechDuration)
	InstancePrefs_addDouble       (TextGridArea, transcribe_vadMinSpeech,  1, theVadDefaultMinSpeechDuration)
	InstancePrefs_addDouble       (TextGridArea, transcribe_vadPadding,    1, theVadDefaultSpeechPad)
	InstancePrefs_addInteger      (TextGridArea, diarize_numSpeakers,	   1, theDiarizationNumSpeakers)
	InstancePrefs_addInteger      (TextGridArea, diarize_minSpeakers,	   1, theDiarizationMinSpeakers)
	InstancePrefs_addInteger      (TextGridArea, diarize_maxSpeakers,	   1, theDiarizationMaxSpeakers)
	InstancePrefs_addBool         (TextGridArea, diarize_allowSpeakersOverlap, 1, theDiarizationAllowSpeakersOverlap)
	...
	InstancePrefs_addDouble       (TextGridArea, diarize_clusterThreshold, 1, theDiarizationClusterThreshold)
	InstancePrefs_addDouble       (TextGridArea, diarize_segmentationStep, 1, theDiarizationSegmentationStep)
